...
- Cause 
This problem occurs because the HarmonyOS bundle parameters are not configured. For details, see [How Do I Set HarmonyOS Bundle Parameters?](common-development-scenarios.md#How Do I Set HarmonyOS Bundle Parameters?). After the configuration is complete, repack the package.
