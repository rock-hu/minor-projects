...
class GetterSetterValidation : public InvariantBase<VerifierInvariants::GETTER_SETTER_VALIDATION> {
public:
    using Base::Base;
...
#endif  // ES2PANDA_COMPILER_CORE_AST_VERIFIER_INVARIANTS_GETTERSETTERVALIDATION_H
