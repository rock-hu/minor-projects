...
#ifndef ES2PANDA_COMPILER_CORE_AST_VERIFIER_INVARIANTS_MODIFIERACCESSVALID_H
#define ES2PANDA_COMPILER_CORE_AST_VERIFIER_INVARIANTS_MODIFIERACCESSVALID_H

#include "../invariantBase.h"

namespace ark::es2panda::compiler::ast_verifier {

class ModifierAccessValid : public InvariantBase<VerifierInvariants::MODIFIER_ACCESS_VALID> {
public:
    using Base::Base;
