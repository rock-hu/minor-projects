...
#ifndef CONVERT_CHAIN_H
#define CONVERT_CHAIN_H

#include "refactor_types.h"

namespace ark::es2panda::lsp {

constexpr RefactorActionView TO_NAMED_CHAIN_ACTION {"Convert to optional chain expression",
                                                    "Convert to optional chain expression",
                                                    "refactor.rewrite.expression.optionalChain"};
class ConvertChainRefactor : public Refactor {
public:
    ConvertChainRefactor();
