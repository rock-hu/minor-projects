...
#include "common_components/common_runtime/src/heap/w_collector/enum_barrier.h"
#include "common_components/common_runtime/src/heap/w_collector/trace_barrier.h"
#include "common_components/common_runtime/src/heap/w_collector/post_trace_barrier.h"
...
ssize_t HeapImpl::GetHeapPhysicalMemorySize() const
{
    CString smapsFile = CString("/proc/") + CString(panda::GetPid()) + "/smaps";
