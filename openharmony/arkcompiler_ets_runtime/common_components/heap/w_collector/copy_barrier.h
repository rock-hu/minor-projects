...
#ifndef COMMON_COMPONENTS_HEAP_W_COLLECTOR_COPY_BARRIER_H
#define COMMON_COMPONENTS_HEAP_W_COLLECTOR_COPY_BARRIER_H
...
#endif // COMMON_COMPONENTS_HEAP_W_COLLECTOR_COPY_BARRIER_H
