...
#ifndef COMMON_COMPONENTS_HEAP_W_COLLECTOR_TRACE_FIX_BARRIER_H
#define COMMON_COMPONENTS_HEAP_W_COLLECTOR_TRACE_FIX_BARRIER_H
...
#endif // COMMON_COMPONENTS_HEAP_W_COLLECTOR_TRACE_FIX_BARRIER_H
