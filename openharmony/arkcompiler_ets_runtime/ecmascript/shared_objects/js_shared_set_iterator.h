...
#ifndef ECMASCRIPT_JS_SHARED_SET_ITERATOR_H
#define ECMASCRIPT_JS_SHARED_SET_ITERATOR_H

#include "ecmascript/js_object.h"
#include "ecmascript/js_iterator.h"

namespace panda::ecmascript {
class JSSharedSetIterator : public JSObject {
public:
    CAST_CHECK(JSSharedSetIterator, IsJSSharedSetIterator);
...
#endif  // ECMASCRIPT_JS_SHARED_SET_ITERATOR_H
