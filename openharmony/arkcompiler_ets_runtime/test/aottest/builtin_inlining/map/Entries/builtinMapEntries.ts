...
//aot: [trace] aot call builtin: Map.entries, caller function name:func_main_0@builtinMapEntries
...
try {
    //aot: [trace] aot call builtin: Map.entries, caller function name:#*#doEntries@builtinMapEntries
