...
//aot: [trace] aot call builtin: Set.entries, caller function name:func_main_0@builtinSetEntries
...
try {
    //aot: [trace] aot call builtin: Set.entries, caller function name:#*#doEntries@builtinSetEntries
