...
//aot: [trace] aot call builtin: Set.values, caller function name:func_main_0@builtinSetValues
print(mySet.values()); //: [object Set Iterator]

// Check with single param
//aot: [trace] aot call builtin: Set.values, caller function name:func_main_0@builtinSetValues
//aot: [trace] aot call builtin: SetIterator.next, caller function name:func_main_0@builtinSetValues
...
try {
    //aot: [trace] aot call builtin: Set.values, caller function name:#*#doValues@builtinSetValues
