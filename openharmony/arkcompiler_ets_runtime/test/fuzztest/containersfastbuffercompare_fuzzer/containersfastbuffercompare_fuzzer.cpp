...
#include "containersfastbuffercompare_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersFastBufferCompareFuzzTest(const uint8_t* data, size_t size)
    {
        ...
        EcmaVM *vm = JSNApi::CreateJSVM(option);
        {
            ...
            int32_t targetEnd = fdp.ConsumeIntegral<int32_t>();
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersFastBufferCompareFuzzTest(data, size);
    return 0;
}