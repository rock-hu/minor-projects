...
#include "containersfastbufferwrite_fuzzer.h"
...
namespace OHOS {
    ...
    void ContainersFastBufferWriteOfFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ContainersFastBufferWriteOfFuzzTest(data, size);
    return 0;
}