...
class TestTaskPool:
    ...
    def setup_method(self):
        logging.info('Start running TestTaskPool: setup')

        self.log_path = rf'{os.path.dirname(__file__)}\..\log'
        self.hilog_file_name = 'test_task_pool.hilog.txt'
    ...
    def teardown_method(self):
        ...
        logging.info('TestTaskPool done')

    def test(self, test_suite_taskpool_01_debug):
        logging.info('Start running TestTaskPool: test')
