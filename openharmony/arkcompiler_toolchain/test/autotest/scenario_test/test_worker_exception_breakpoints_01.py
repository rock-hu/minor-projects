...
class TestWorkerExceptionBreakpoints01:
    """
    测试用例：多实例 debug 调试异常断点 ALL 和 NONE 模式
    测试步骤：
    ...
    def setup_method(self):
        logging.info('Start running TestWorkerExceptionBreakpoints01: setup')

        self.log_path = rf'{os.path.dirname(__file__)}\..\log'
        self.hilog_file_name = 'test_worker_exception_breakpoints_01.hilog.txt'
    ...
    def teardown_method(self):
        ...
        logging.info('TestWorkerExceptionBreakpoints01 done')

    def test(self, test_suite_worker_03_debug):
        logging.info('Start running TestWorkerExceptionBreakpoints01: test')
