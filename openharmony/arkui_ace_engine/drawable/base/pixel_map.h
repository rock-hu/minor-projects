...
#ifndef FOUNDATION_ACE_DRAWABLE_DESCRIPTOR_BASE_PIXEL_MAP_H
#define FOUNDATION_ACE_DRAWABLE_DESCRIPTOR_BASE_PIXEL_MAP_H
...
enum class ResizableOption : int32_t {
    LEFT = 0,
    RIGHT = 1,
    TOP = 2,
    BOTTOM = 3,
...
#endif // FOUNDATION_ACE_DRAWABLE_DESCRIPTOR_BASE_PIXEL_MAP_H
