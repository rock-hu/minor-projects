...
import { GridContainerOptions, GridContainerAttribute } from "./ArkGridContainerInterfaces"
/** @memo:stable */
export class ArkGridContainerComponent extends ArkColumnComponent {
...
/** @memo */
export function ArkGridContainer(
  /** @memo */
  style: ((attributes: ArkGridContainerComponent) => void) | undefined,
  /** @memo */
