...
export function ARKTS_TEST_ASSERTION(node: arkts.EtsScript, source: string, state?: arkts.Es2pandaContextState) {
    ...
    try {
        const script = arkts.EtsScript.createFromSource(source, finalState)
