...
import * as ohosRouter from "#arkcompat/ohos.router"
 ...
 export interface RouterOptions {
  ...
  export default class Router {
    ...
    static push(options: RouterOptions): void {
        ohosRouter.router.push({url: options.uri, params: options.params})
    }
    ...
    static replace(options: RouterOptions): void {
        ohosRouter.router.replace({url: options.uri, params: options.params})
    }
    ...
    static back(options?: BackRouterOptions): void {
        ohosRouter.router.back(options?.uri ? {url: options?.uri, params: options?.params} : undefined)
    }
    ...
    static getParams(): ParamsInterface {
        return ohosRouter.router.getParams()
    }
    ...
    static getLength(): string {
        return ohosRouter.router.getLength()
    }
    ...
    static getState(): RouterState {
        let state = ohosRouter.router.getState()
        return {
            index: state.index,
            path: state.path,
            name: state.name
    ...
    static enableAlertBeforeBackPage(options: EnableAlertBeforeBackPageOptions): void {
        throw new Error("enableAlertBeforeBackPage() unimplemented")
    }
    ...
    static disableAlertBeforeBackPage(options?: DisableAlertBeforeBackPageOptions): void {
        throw new Error("disableAlertBeforeBackPage() unimplemented")
    }
  }
