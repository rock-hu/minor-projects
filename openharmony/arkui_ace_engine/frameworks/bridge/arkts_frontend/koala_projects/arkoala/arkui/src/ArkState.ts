...
export { contextLocalStateOf, propState, objectLinkState, SyncedProperty } from "@koalaui/arkui-common"
export { MutableState, OnChange, contextLocal } from "@koalaui/runtime"
 ...
 */
export function stateOf<Value>(value: Value, instance?: CustomComponent, index?: number): MutableState<Value> {
