...
import { HoverCallback, SizeChangeCallback, VisibleAreaEventOptions, VisibleAreaChangeCallback, EventTarget, SourceType, SourceTool, TouchObject, HistoricalPoint, IntentionCode } from "./ArkCommonInterfaces"
...
import { TouchType, KeyType, KeySource, MouseButton, MouseAction } from "./ArkEnumsInterfaces"
...
export class UICommonEventInternal implements MaterializedBase,UICommonEvent {
    ...
    private setOnVisibleAreaApproximateChange_serialize(options: VisibleAreaEventOptions, event?: VisibleAreaChangeCallback): void {
        ...
        thisSerializer.writeInt8(event_type)
