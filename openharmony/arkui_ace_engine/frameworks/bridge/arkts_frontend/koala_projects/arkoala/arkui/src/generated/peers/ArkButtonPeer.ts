...
export class ArkButtonPeer extends ArkCommonMethodPeer {
    ...
    setButtonOptions2Attribute(label: ResourceStr, options?: ButtonOptions): void {
        ...
        if (RuntimeType.STRING == label_type) {
            ...
            const label_0 = unsafeCast<string>(label)
            thisSerializer.writeString(label_0)
        }
        else if (RuntimeType.OBJECT == label_type) {
            thisSerializer.writeInt8(1)
            const label_1 = unsafeCast<Resource>(label)
    ...
    typeAttribute(value: ButtonType): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_type(this.peer.ptr, value)
    }
    stateEffectAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_stateEffect(this.peer.ptr, +value)
    }
    buttonStyleAttribute(value: ButtonStyleMode): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_buttonStyle(this.peer.ptr, value)
    }
    controlSizeAttribute(value: ControlSize): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_controlSize(this.peer.ptr, value)
    }
    roleAttribute(value: ButtonRole): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_role(this.peer.ptr, value)
    }
    ...
    fontStyleAttribute(value: FontStyle): void {
        ArkUIGeneratedNativeModule._ButtonAttribute_fontStyle(this.peer.ptr, value)
    }
