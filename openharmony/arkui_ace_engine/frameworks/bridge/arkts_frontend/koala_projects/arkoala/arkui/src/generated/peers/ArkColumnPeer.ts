...
export class ArkColumnPeer extends ArkCommonMethodPeer {
    ...
    alignItemsAttribute(value: HorizontalAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_alignItems(this.peer.ptr, value)
    }
    justifyContentAttribute(value: FlexAlign): void {
        ArkUIGeneratedNativeModule._ColumnAttribute_justifyContent(this.peer.ptr, value)
    }
