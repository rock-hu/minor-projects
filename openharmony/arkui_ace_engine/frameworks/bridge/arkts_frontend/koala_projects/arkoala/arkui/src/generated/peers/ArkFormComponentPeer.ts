...
export class ArkFormComponentPeer extends ArkCommonMethodPeer {
    ...
    dimensionAttribute(value: FormDimension): void {
        ArkUIGeneratedNativeModule._FormComponentAttribute_dimension(this.peer.ptr, value)
    }
    allowUpdateAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._FormComponentAttribute_allowUpdate(this.peer.ptr, +value)
    }
    visibilityAttribute(value: Visibility): void {
        ArkUIGeneratedNativeModule._FormComponentAttribute_visibility(this.peer.ptr, value)
    }
