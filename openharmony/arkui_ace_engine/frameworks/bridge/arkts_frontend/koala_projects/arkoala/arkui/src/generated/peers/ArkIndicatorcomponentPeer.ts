...
export class ArkIndicatorComponentPeer extends ArkCommonMethodPeer {
    ...
    loopAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._IndicatorComponentAttribute_loop(this.peer.ptr, +value)
    }
    verticalAttribute(value: boolean): void {
        ArkUIGeneratedNativeModule._IndicatorComponentAttribute_vertical(this.peer.ptr, +value)
    }
