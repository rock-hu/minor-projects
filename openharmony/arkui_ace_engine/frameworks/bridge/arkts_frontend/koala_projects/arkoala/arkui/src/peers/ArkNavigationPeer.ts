...
import { ArkCommonMethodAttributes, ArkCommonMethodPeer } from "../generated/peers/ArkCommonPeer"
...
export class ArkNavigationPeer extends ArkCommonMethodPeer {
    ...
    onTitleModeChangeAttribute(value: (a1: NavigationTitleMode) => void): void {
    ...
    onNavBarStateChangeAttribute(value: (a1: boolean) => void): void {
    ...
    onNavigationModeChangeAttribute(value: (a1: NavigationMode) => void): void {
    ...
    navDestinationAttribute(value: (a1: string, a2: object) => void): void {
    ...
    customNavContentTransitionAttribute(value: (a1: NavContentInfo, a2: NavContentInfo, a3: NavigationOperation) => NavigationAnimatedTransition | undefined): void {
...
export interface ArkNavigationAttributes extends ArkCommonMethodAttributes {
    ...
    hideToolBar?: boolean
    onTitleModeChange?: (a1: NavigationTitleMode) => void,
    onNavBarStateChange?: (a1: boolean) => void
    onNavigationModeChange?: (a1: NavigationMode) => void
    navDestination?: (a1: string, a2: object) => void
    customNavContentTransition?: (a1: NavContentInfo, a2: NavContentInfo, a3: NavigationOperation) => NavigationAnimatedTransition | undefined
