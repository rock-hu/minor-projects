import { ArkButton, ArkColumn, ArkCommonMethodComponent, ArkFlex, ArkPageTransitionEnterComponent, ArkPageTransitionExitComponent, ColumnOptions, FlexOptions } from "@koalaui/arkts-arkui";
/*
...
function main() {
    ArkColumn(undefined, () => {
        ArkFlex(undefined, undefined, { justifyContent: 30 } as FlexOptions);
    }, { space: 30 } as ColumnOptions);
}
