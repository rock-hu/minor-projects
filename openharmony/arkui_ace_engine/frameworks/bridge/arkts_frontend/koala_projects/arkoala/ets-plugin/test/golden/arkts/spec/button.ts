import { ArkButton, ArkButtonComponent, ArkCommonMethodComponent, ArkFlex, ArkPageTransitionEnterComponent, ArkPageTransitionExitComponent, ArkRow, ArkRowComponent, ArkStructBase, ArkText, ArkTextComponent, ButtonOptions, ButtonType, FlexAlign, FlexDirection, FlexOptions, ItemAlign, VerticalAlign } from "@koalaui/arkts-arkui";
    ...
    content?: () => void, initializers?: ButtonExampleOptions) {
        ArkFlex(__builder, () => {
            ArkFlex(undefined, () => {
                ...
                }, { type: ButtonType.Normal, stateEffect: true } as ButtonOptions);
                ArkButton((__instance: ArkButtonComponent) => {
                    __instance.opacity(0.5)
                        .borderRadius(8).backgroundColor(0x317aff).width(90);
                }, undefined, 'Disable', { type: ButtonType.Normal, stateEffect: false });
            }, { alignItems: ItemAlign.Center, justifyContent: FlexAlign.SpaceBetween } as FlexOptions);
        }, { direction: FlexDirection.Column, alignItems: ItemAlign.Start, justifyContent: FlexAlign.SpaceBetween } as FlexOptions);
    }
}
export {};
/** @memo */
