...
void callManagedCallback_Any_Void(Ark_Int32 resourceId, Ark_CustomObject info)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
...
void callManagedCallback_IsolatedComponentAttribute_Void(Ark_Int32 resourceId, Ark_IsolatedComponentAttribute value)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
...
void callManagedCallback_Literal_Function_handler_Object_error_Void(Ark_Int32 resourceId, Opt_Literal_Function_handler_Object_error event)
{
    ...
    if ((INTEROP_RUNTIME_UNDEFINED) != (event_type)) {
        ...
        argsSerializer.writeCustomObject("Object", event_value_error);
    }
    enqueueCallback(&_buffer);
}
...
void callManagedCallback_Literal_Number_code_Want_want_Void(Ark_Int32 resourceId, Ark_Literal_Number_code_Want_want parameter)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
...
void callManagedCallback_Literal_Object_detail_Boolean(Ark_Int32 resourceId, Opt_Literal_Object_detail event, Callback_Boolean_Void continuation)
{
    ...
    if ((INTEROP_RUNTIME_UNDEFINED) != (event_type)) {
        ...
        argsSerializer.writeCustomObject("Object", event_value_detail);
    }
    argsSerializer.writeCallbackResource(continuation.resource);
    argsSerializer.writePointer(reinterpret_cast<Ark_NativePointer>(continuation.call));
    argsSerializer.writePointer(reinterpret_cast<Ark_NativePointer>(continuation.callSync));
...
void callManagedCallback_String_Unknown_Void(Ark_Int32 resourceId, Ark_String name, Ark_CustomObject param)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
    ...
    argsSerializer.writeCustomObject("Any", param);
    enqueueCallback(&_buffer);
}
...
void callManagedIsolatedComponentInterface(Ark_Int32 resourceId, Ark_IsolatedOptions options, Callback_IsolatedComponentAttribute_Void continuation)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
...
void callManagedOnNativeLoadCallback(Ark_Int32 resourceId, Opt_CustomObject event)
{
    CallbackBuffer _buffer = {{}, {}};
    const Ark_CallbackResource _callbackResource = {resourceId, holdManagedCallbackResource, releaseManagedCallbackResource};
    _buffer.resourceHolder.holdCallbackResource(&_callbackResource);
    ...
    if ((INTEROP_RUNTIME_UNDEFINED) != (event_type)) {
        const auto event_value = event.value;
        argsSerializer.writeCustomObject("Object", event_value);
    }
    enqueueCallback(&_buffer);
}
...
void callManagedType_WebAttribute_onFileSelectorShow_callback(Ark_Int32 resourceId, Opt_Literal_Function_callback__Object_fileSelector event)
{
    ...
    if ((INTEROP_RUNTIME_UNDEFINED) != (event_type)) {
        ...
        argsSerializer.writeCustomObject("Object", event_value_fileSelector);
    }
    enqueueCallback(&_buffer);
}
...
Ark_NativePointer getManagedCallbackCaller(CallbackKind kind)
{
    switch (kind) {
        ...
        case Kind_Callback_Literal_Number_code_Want_want_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_Literal_Number_code_Want_want_Void);
        ...
        case Kind_IsolatedComponentInterface: return reinterpret_cast<Ark_NativePointer>(callManagedIsolatedComponentInterface);
...
Ark_NativePointer getManagedCallbackCallerSync(CallbackKind kind)
{
    switch (kind) {
        ...
        case Kind_Callback_Literal_Number_code_Want_want_Void: return reinterpret_cast<Ark_NativePointer>(callManagedCallback_Literal_Number_code_Want_want_VoidSync);
        ...
        case Kind_IsolatedComponentInterface: return reinterpret_cast<Ark_NativePointer>(callManagedIsolatedComponentInterfaceSync);
