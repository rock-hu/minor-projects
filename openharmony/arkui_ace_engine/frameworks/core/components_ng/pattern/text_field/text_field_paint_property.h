...
public:
    ...
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(OuterBorderRadiusFlagByUser, BorderRadiusProperty, PROPERTY_UPDATE_NORMAL);
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(OuterBorderColorFlagByUser, BorderColorProperty, PROPERTY_UPDATE_NORMAL);
    ACE_DEFINE_PROPERTY_ITEM_WITHOUT_GROUP(OuterBorderWidthFlagByUser, BorderWidthProperty, PROPERTY_UPDATE_NORMAL);
