 ...
 * @tc.desc: CanvasLayoutAlgorithm::MeasureLayoutPolicySize
 * @tc.type: FUNC
 */
HWTEST_F(CanvasTestNg, MeasureLayoutPolicySizeTest001, TestSize.Level1)
{
    auto* stack = ViewStackProcessor::GetInstance();
    auto nodeId = stack->ClaimNodeId();
    auto frameNode = FrameNode::GetOrCreateFrameNode(
    ...
    canvasLayoutAlgorithm->MeasureLayoutPolicySize(layoutConstraint, &layoutWrapper, size);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(CanvasTestNg, MeasureLayoutPolicySizeTest002, TestSize.Level1)
{
    auto* stack = ViewStackProcessor::GetInstance();
    auto nodeId = stack->ClaimNodeId();
    auto frameNode = FrameNode::GetOrCreateFrameNode(
