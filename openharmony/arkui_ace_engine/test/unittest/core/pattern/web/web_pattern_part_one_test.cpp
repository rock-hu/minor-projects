 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, OnDetachContext_001, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, OnDetachContext_002, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, OnDetachContext_003, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, OnDetachContext_004, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, OnDetachContext_005, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    ASSERT_NE(stack, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(WebPatternPartOneTest, RegisterSelectOverLayOnClose001, TestSize.Level1)
{
#ifdef OHOS_STANDARD_SYSTEM
    auto* stack = ViewStackProcessor::GetInstance();
    EXPECT_NE(stack, nullptr);
